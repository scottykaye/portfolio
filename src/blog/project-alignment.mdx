...
date: '10/25/2024'
description:
  'You start inspired and sometimes lose site of project goals. How losing site
  of the goal can destroy strong driven teams.'
---
...
establishing ownership of tasks, build "super projects" and having a clear road
map will experience burnout, scope creep, and lack of trust among one another.
It can become toxic. Folks who worked together for years can feel pinned against
each other.
...
Overtime these mistakes lead to becoming ingrained in the teams culture.
...
It's important in this phase to make sure every one is aligned on what the
business goals are and what the feature values are to achieve these goals.

Start keeping a record of features. It's easy for people to feel on the same
...
epics but can and should be broken down into smaller ones more manageable
chunks.

### Accountability & ownership

We need to assign ownership to tasks and subtasks. We need to find ways to break
down the project into smaller chunks. If you're a team of senior engineers each
person should own a chunk. This allows that person to be responsible for final
calls on decision making for that part of the project. It makes someone
accountable for the task at hand and allows you to be more successful
disagreeing and committing to the owner of that task. This ownership creates a
sense of trust between team members and assigns value to their worth as an
...
Sometimes you have long huge projects and you want to start to skip your team
rituals because you want more heads down time, if your team finds itself in this
situation your team has lost the plot and did not plan the project effectively.
...
Following these steps will serves as a guide to keeping your team on track and
aligned.
